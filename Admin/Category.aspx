<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="ECommerceWebsite.Admin.Category" %>
                ...
                <div class="card-body">
                    ...
                    <div class="form-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ForeColor="Red" Font-Size="Small" Display="Dynamic"
                        ...
                        <div class="row"> 
                            <div class="col-md-12">
                                <div class="form-group">
                                    <asp:CheckBox ID="cbIsActive" runat="server" Text="&nbsp; IsActive"></asp:CheckBox>
                        ...
                        <asp:Repeater ID="rCategory" runat="server" OnItemCommand="rCategory_ItemCommand">
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <img width="40" src="<%#ECommerceWebsite.Admin.Connection.getImageUrl(Eval("CategoryImageUrl")) %>" alt="Image"/>
                                    </td>
                                    <td>

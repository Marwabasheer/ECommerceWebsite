...
namespace ECommerceWebsite.Admin
{
	public partial class Category : System.Web.UI.Page
	{
		...
		{
			Session["breadCumbTitle"] = "Message Category";
		...
		protected void btnAddOrUpdate_Click(object sender, EventArgs e)
		{
			...
			{
				if (Connection.isValidExtension(fuCategoryImage.FileName))
				{
					string newImageName = Connection.getUniqueId();
					...
					cmd.Parameters.AddWithValue("@Category_ImageUrl", imagePath);
					isValidaToExecute = true;
				}
				else
				{
					lblmsg.Visible = false;
					lblmsg.Text = "Please select .jpg, .png or .jpeg files";
					lblmsg.CssClass = "alert alert-danger";
					isValidaToExecute = false;
				}
			}
			else
			{
